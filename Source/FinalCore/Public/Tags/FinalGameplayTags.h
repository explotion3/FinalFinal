...
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Final_Keyword_SwordArray);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_Final_Keyword_Opening);
UE_DECLARE_GAMEPLAY_TAG_EXTERN(TAG_First_Keyword_Swift);
