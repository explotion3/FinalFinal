...
void UFinalUISubsystem::EnsureFlowScreens()
{
	...
	{
		RewardOverlayScreen = CreateWidget<UFinalRunRewardOverlayScreen>(PrimaryPlayerController, UFinalUIWidgetClassSettings::GetRunRewardOverlayScreenClass());
	}
	...
	{
		EventNodeOverlayScreen = CreateWidget<UFinalRunEventNodeOverlayScreen>(PrimaryPlayerController, UFinalUIWidgetClassSettings::GetRunEventNodeOverlayScreenClass());
	}
