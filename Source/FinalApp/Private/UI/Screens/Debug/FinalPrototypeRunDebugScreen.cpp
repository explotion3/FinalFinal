...
FText GetPrototypeRunRelicEffectTypeText(const EFinalRelicBattleStartEffectType EffectType)
{
	switch (EffectType)
	{
...
FString BuildBattleRelicEffectSummaryString(const TArray<FFinalBattleStartRelicEffectInput>& EffectInputs)
{
	...
	{
		const FString EffectTypeString = GetPrototypeRunRelicEffectTypeText(EffectInput.EffectType).ToString();
